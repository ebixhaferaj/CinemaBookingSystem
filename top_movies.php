    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="top_movies.php">Top Movies</a>
                            </li>
                            <li class="nav-item">
            ...
            <main class="col-xxl-10 col-lg-10 col-md-11 col-sm-10 px-0 mx-auto py-5">
                <h3 style="color:grey; font-family: 'Brush Script MT', cursive; text-align:center;">- get a taste of our favorites -</h3>
                
                <?php
                // Query to get top movies based on reservations
                $sql = "
                SELECT m.movie_id, m.movie_title, m.genre, m.cover, COUNT(b.booking_id) AS total_reservations
                FROM movie m
                JOIN movie_show ms ON m.movie_id = ms.movie_id_fk
                JOIN booking b ON ms.show_id = b.show_id_fk
                GROUP BY m.movie_id
                ORDER BY total_reservations DESC
                LIMIT 5"; // Limit to top 10 movies for display
