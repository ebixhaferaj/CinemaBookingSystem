        ...
        if ($result->num_rows > 0) {
            ...
            if ($stmt) {
                ...
                if ($stmt->affected_rows > 0) {
                    ...
                    header("Location: ../members.php?success=$success_message");
                    exit;
                } else {
                    $error_message = "Failed to remove hall. Please try again.";
                    header("Location: ../members.php?error=$error_message");
                    echo("error");
                    exit;
                }
            } else {
            ...
            $em = "Hall not found!";
            header("Location: ../members.php?error=$em");
            exit;
        }
    }
} else {
    header("Location: ../members.php?error=All fields are required.");
    exit;
}
?>
