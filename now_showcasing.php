    ...
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarScroll">
                        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="now_showcasing.php">Now Showcasing</a>
                            </li>
                            <li class="nav-item">
            ...
            <main class="col-xxl-10 col-lg-10 col-md-11 col-sm-10 px-0 mx-auto py-5">
                <h3 style="color:grey; font-family: 'Brush Script MT', cursive; text-align:center;">- this week -</h3>
                
                <?php
                // Query to get this week's movies
                $sql = "
                SELECT m.movie_id, m.movie_title, m.genre, m.cover
                FROM movie m
                JOIN movie_show ms ON m.movie_id = ms.movie_id_fk
                WHERE ms.show_date BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 6 DAY)
                GROUP BY m.movie_id";
